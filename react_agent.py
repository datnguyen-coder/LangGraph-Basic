...
class AgentState(TypedDict):
    messages: Annotated[Sequence[BaseMessage], add_messages] # preserve the state by appending rather then overwriting
...
def subtract(a: int, b: int):
    """This is an addition function that subtracts 2 numbers together"""
...
def multiply(a: int, b: int):
    """This is an addition function that multiplies 2 numbers together"""
